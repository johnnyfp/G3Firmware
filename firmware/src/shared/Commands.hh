...
#define HOST_CMD_MOOD_LIGHT_SET_RGB     210
#define HOST_CMD_MOOD_LIGHT_SET_HSB     211
#define HOST_CMD_MOOD_LIGHT_PLAY_SCRIPT 212
#define HOST_CMD_BUZZER_REPEATS		213
#define HOST_CMD_BUZZER_BUZZ		214
